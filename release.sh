...
POM_RELEASE_TAG="${RELEASE_VERSION}.RELEASE"
...
$MVN versions:set -DgenerateBackupPoms=false -DnewVersion=$POM_RELEASE_TAG || die_with "Failed to set release version on pom.xml files"
